const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Phương Dương năm mới vui vẻ hạnh phúc đạt được nhiều thành tựu tuyệt vời hơn nữa 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/Dnp.jpg",    //ảnh pop up đầu
      imageWidth: 300,
      imageHeight: 300,
